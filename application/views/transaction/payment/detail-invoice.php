	...
	<div class="invoice p-3 mb-3">
		...
		<div class="row invoice-info">
			...
			<div class="col-sm-4 invoice-col">
				<!-- <b>Invoice <?php echo $invoice['invoice_number'];?></b><br>
				<br>
			...
			<div class="col-6">
				...
				<div class="table-responsive">
					<table class="table table-valign-middle">
						...
						<?php if ($invoice['payment_dp'] != null) {?>

						<tr>
							<th style="width:50%">Pembayaran Dimuka</th>
							<td>Rp </td>
							<td class="text-right"><?php echo number_format($invoice['payment_dp'], 2, '.', ',');?></td>
						</tr>
						...
						<tr>
							...
							<td class="text-right">
								...
								if ($invoice['payment_dp'] != null) {
									echo number_format($invoice['grand_total'] - $invoice['dp_nominal'], 2, '.', ',');
								} else {
				...
				<p class="lead">Dibayar tanggal: <?php echo date_format(date_create($invoice['payment_date']), 'd M Y H:i:s');?></p>
