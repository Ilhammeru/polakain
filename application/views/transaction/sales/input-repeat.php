                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <input type="hidden" id="customer_ref" placeholder="#Customer" class="form-control form-left">
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response == 'success') {
                            ...
                            setTimeout(function() {
                                location.href = "<?= site_url('sales/input_repeat'); ?>";
                            }, 1500);
                        ...
                        } else if (response == 'visitor-null') {

                            Swal.fire({
                                icon: 'error',
                                title: 'Oops...',
                                text: 'Visitor belum terdaftar di website visitor',
                            });
                        }
                    }
                });
