...
<style>
    /* ----------------------------------------------
    * Generated by Animista on 2021-6-15 20:41:32
...
<div class="row">
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 offset-md-3 main-col">
...
<script>
    function print(id, code) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                } else if (response == 'array-err') {
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'Maksimal hanya bisa 3 baris',
                    });
                } else {
    ...
    function view_print(id) {
        $('.main-col').removeClass('offset-md-3');
        setTimeout(() => {
            $('.second-col').show();
            $('.second-col').css({
                "left": "0"
            });
            $('.second-col').addClass('col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6');
            $('.second-col').addClass('scale-in-center');
        }, 300);
        // $('.main-col').removeClass('col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6');
        // $('.main-col').addClass('col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6')
