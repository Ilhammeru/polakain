	...
	<div class="row">
		...
		<div class="col-md-6 offset-md-3 col-sm-8 offset-sm-2">
			...
			<div class="card card-primary">
				...
				<form id="form-new-warehouse" role="form" method="post" action="<?=site_url('warehouse/save_new_warehouse');?>">
					            ...
					            success: function(response) {
					            	...
					            	if (response == 'success') {
					            		...
					            		setTimeout(function(){
											...
											$('#form-new-warehouse input').removeClass('is-valid');
											$(form)[0].reset();	
					            		...
					            		setTimeout(function(){
											...
											$('#form-new-warehouse input').addClass('is-invalid');
